...
**TL;DR** Download [Boiling Insights.App file for Mac OSX (arm64)](http://boilingdata-public.s3-website-eu-west-1.amazonaws.com/BoilingInsights-v0.8.19-arm64-mac.zip).
...
1. Download zip compressed [Boiling Insights.App file for Mac OSX (arm64)](http://boilingdata-public.s3-website-eu-west-1.amazonaws.com/BoilingInsights-v0.8.19-arm64-mac.zip)
